...
const Navbar = (props) => {
  ...
  return (
    <nav
      className={`navbar ${scrollNavClass}`}
      style={{ background: !props.isExact ? "#fbfbfb" : "transparent" }}
    >
      <div className="container nav-flex">
        ...
        <ul className="nav-links">
          <li>
            <NavLink
              to="/"
              style={{ color: !props.isExact ? "#353535" : "#fff" }}
        ...
        <div
          className={`hamburger-menu ${addClass ? "menu-click" : null}`}
